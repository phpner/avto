...
<script type="text/javascript" src="polir/js/nav.js"</script>
...
Полировка кузова<br/>
Освежит цвет и удалит царапины!</span>
<span class="form">
<form action="polir/zakaz.php" method="post" class="orderform" id="orderform1">
<div class="input"><input required class="pol" name="name" type="text" placeholder="Имя"></div>
<div class="input"><input required class="pol" title="Введите номер телефона без пробелов. 8XXXXXXXXX." name="phone" type="tel" pattern="[0-9]{7,12}" placeholder="Телефон"></div>
...
И рассчитаем стоимость полировки для Вашего автомобиля</span>
<span class="form">
<form action="polir/zakaz.php" method="post" class="orderform" id="orderform1">
<div class="input"><input required class="pol" name="name" type="text" placeholder="Имя"></div>
<div class="input"><input required class="pol" title="Введите номер телефона без пробелов. 8XXXXXXXXX." name="phone" type="tel" pattern="[0-9]{7,12}" placeholder="Телефон"></div>
...
<br>
<div align="center">
<a class="two" rel="group" title="Сертификат" href="polir/images/clients/001AS.jpg"><img src="polir/images/clients/001AS01.jpg" /></a>
<a class="two" rel="group" title="Приложение" href="polir/images/clients/002AS.jpg"><img src="polir/images/clients/002AS01.jpg" /></a>
...
<img src="polir/images/nam19.png" alt="">
...
<div class="item clear_self">
<img src="polir/images/nam18.png" alt="">
<div class="georgia">Александр, Opel Astra 28.01.2016 делали глубокую полировку. Результатом очень приятно удивлён, даже ошеломлён! Это колдовство какое-то) Уже в который раз убеждаюсь, что в AutoStyle все делают на уровне, всем рекомендую!  <a href="http://vk.com/q_u_z_a" target="_blank">http://vk.com/q_u_z_a</a>
</div>
</div><br>
...
<div class="item clear_self">
<img src="polir/images/nam15.png" alt="">
<div class="georgia">Сергей, Lexus LX 470. Делал глубокую полировку кузова 16.08.2015. Отличная работа! Спасибо! )))			
<a href="https://www.facebook.com/sergei.sololob?fref=ufi&pnref=story" target="_blank">https://www.facebook.com/sergei.sololob?fref=ufi&pnref=story</a>
</div>
</div>	<br><br>
...
<div class="item clear_self">
<img src="polir/images/nam13.png" alt="">
<div class="georgia">Александр, Mazda 6. Делал глубокую полировку кузова 09.07.2015. Огромное СПАСИБО за полировку, все на высшем уровне!!!			
<a href="http://vk.com/nonamezzz74" target="_blank">http://vk.com/nonamezzz74</a>
</div>
</div>	<br><br>
...
<div class="item clear_self">
<img src="polir/images/nam11.png" alt="">
...
<div class="item clear_self">
<img src="polir/images/nam2.png" alt="">
...
<div class="item clear_self">
<img src="polir/images/nam12.png" alt="">
...
<div class="item clear_self">
<img src="polir/images/nam6.png" alt="">
...
<div class="item clear_self">
<img src="polir/images/nam17.png" alt="">
<div class="georgia">Виталий, Kia Rio. Полировали и бронировали фары. Все понравилось! Спасибо!!  <a href="http://vk.com/vitt79" target="_blank">http://vk.com/vitt79</a>
</div>
</div><br><br>

<div class="item clear_self">
<img src="polir/images/nam20.png" alt="">
...
<br><br>
<img alt="" src="polir/images/S500.png">
<img alt="" src="polir/images/S1000.png">
<img alt="" src="polir/images/S3000.png">
<img alt="" src="polir/images/S5000.png">
<img alt="" src="polir/images/S10000.png">

<br><br>
<h1>Полировка авто в Челябинске </h1>
<link rel="stylesheet" href="css/spoiler.css" type="text/css" media="screen"/>
<div class='bottomDescription'>
<p style="text-align: justify;">Со временем лакокрасочное покрытие автомобиля начинает стареть и покрываться царапинами и потертостями, особенно в местах расположения дверных ручек, капота, крышки багажника. Автоцентр "AutoStyle" в Челябинске предлагает услугу полировки авто различных видов: полировку кузова автомобиля, бампера и фар.</p>
...
<li style="text-align: justify;">механическую полировку кузова от неглубоких царапин;</li>
<li style="text-align: justify;">защитную полировку деталей кузова (например, полировку бампера);</li>
<li style="text-align: justify;">эпоксидную полировку кузова автомобиля;</li>
<li style="text-align: justify;">полировку фар с обновлением помутневшего пластика;</li>
<li style="text-align: justify;">глубокую полировку автомобиля (абразивную);</li>
<li style="text-align: justify;">полировку кузова автомобиля обычной автополиролью;</li>
<li style="text-align: justify;">полировку автомобиля полиролью на основе нано.</li>
</ul>
<p style="text-align: justify;"></p>
<p style="text-align: justify;"><b>Мы рекомендуем </b></p>
<p justify="">Для того, чтобы содержать кузов в надлежащем виде, следует выполнять его полировку перед наступлением зимы и после ее окончания. Для свежего лакокрасочного покрытия достаточно обработки кузова обычной полиролью, которая поможет вернуть вашему авто прежний блеск и отчасти защитит кузов. Чтобы защитить восстановленный блеск, мы рекомендуем проводить защитную полировку кузова авто.</p>
<p style="text-align: justify;">Для автомобиля, кузов которого давно не знал полировки, и имеет царапины, рекомендуется абразивная глубокая <strong>полировка кузова автомобиля, цена</strong> на которую у нас является доступной. В автоцентре "AutoStyle" работы по полировке авто проводятся только опытными мастерами, которые осуществят для вас полировку стекла автомобиля от царапин, полировку кузова, бампера и других частей вашей машины. .</p>
<p style="text-align: justify;">Если вам необходима <strong>полировка кузова машины в Челябинске, цены</strong> на услуги автоцентра "AutoStyle" вы можете уточнить по телефонам, указанным на сайте.</p>
<p style="text-align: justify;">Также наш центр выполняет работы по <a href="/bron.php">бронированию автомобиля защитной пленкой.</a></p>
</div>
