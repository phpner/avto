...
<span class="zakaz" style="color:#FFFF00;">Акция! <br/>В Апреле -10% скидка<br/>на комплексное бронирование!</span></a>
<span class="form">
...
<p class="label-line gray-label">Я согласен(а) на </p>
<p class="label-line"><a href="#consent-text" class="fancy-consent">обработку персональных данных</a></p>
</div>
</form>
</span>
</div>
...
<a href="/signal.php" target="_blank" style="color:#FFFF00; text-decoration:none"> Акция! <br/> При установке сигнализации в Апреле,<br/>Обходчик иммобилайзера в ПОДАРОК!</span></a>
<span class="form">
<form action="zakaz.php" method="post" class="orderform" id="orderform1">
<div class="input"><input required class="pol" name="name" type="text" placeholder="Имя"></div>
<div class="input"><input required class="pol" title="Введите номер телефона без пробелов. 8XXXXXXXXX." name="phone" type="tel" pattern="[0-9]{7,12}" placeholder="Телефон"></div>
...
<div id="zakaz">
<span class="zakaz" style="color:#FFFF00;">
<a href="/tonirovka.php" target="_blank" style="color:#FFFF00; text-decoration:none"> Акция! <br/> На тонирование в Апреле,<br/>скидка 10%!</span></a>
<span class="form">
<form action="zakaz.php" method="post" class="orderform" id="orderform1">
<div class="input"><input required class="pol" name="name" type="text" placeholder="Имя"></div>
<div class="input"><input required class="pol" title="Введите номер телефона без пробелов. 8XXXXXXXXX." name="phone" type="tel" pattern="[0-9]{7,12}" placeholder="Телефон"></div>
...
<div id="consent-text" style="display:none;">
	...
	Я, заполняя форму на сайте ас74.рф, даю свое согласие администратору сайта ас74.рф, в соответствии с Федеральным законом от 27.07.2006 152-ФЗ «О персональных данных», на обработку, хранение и передачу третьим лицам через Интернет моих персональных данных. Я подтверждаю, что, даю такое согласие, действуя по своей воле и в своем интересе.
	Целью предоставления мною персональных данных является установление связи с администратором сайта ас74.рф, включая направление уведомлений, запросов, касающихся использования сайта, оказания услуг.
	...
	<a href="/Politika.docx">Политика в отношении обработки данных</a>
	</div>
</div>
